...
if(empty($cookie)==false || ($user && $pass)){
	for ($j=0; $j < 2; $j++){
		...
		elseif (stristr($data,"File not found on the host")) die("<font color=red><b>File Not Found Nor Host Is Not Supported Right Now</b></font>");
		elseif (stristr($data,"Bandwidth from this host is used, try again later")) die("<font color=red><b>Bandwitdth Of This Hosting Finished</b></font>");
		elseif (stristr($data,"Host is under maintenance")) die("<font color=red><b>Host Is Under Maintenance</b></font>");
